  ...
  <div className="w-full max-w-md animate-fade-in">
        ...
        <form action="" className=" space-y-5 " onSubmit={handleSubmit}>
          <div>
            ...
            <input type="email" className="" value={email} onChange={  (e) => setEmail(e.target.value)} required  placeholder="Fhin@gmail.com"/>
          </div>
            ...
            <div className="relative">
                   <input type={showPassword ? "text" : "password"} className="pr-11" value={password} onChange={  (e) => setPassword(e.target.value)} required  placeholder="Enter your password"/>
