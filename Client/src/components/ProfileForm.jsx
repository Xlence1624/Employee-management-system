...
<input value={initialData.position} disabled   className="bg-slate-50 text-slate-400 cursor-not-allowed"/>
  </div>
...
<div>
  ...
  <p className='text-xs text-slate-400nmt-1.5'>This will be displayed on your profile.</p>
</div>
...
<div className="p-4 bg-rose-50 border border-rose-200 rounded-xl text-center ">
  ...
  <p className='text-sm text-rose-500 mt-0.5'>You can no longer update your profile</p>
    ...
    <div className='flex justify-end pt-2'>
      ...
      <button className="btn-primary flex items-center gap-2 justify-center w-full sm:w-auto" type='submit'>
        
        {loading ? <Loader2 className='w-4 h-4 animate-spin'/> : <SaveIcon className='w-4 h-4'/>}
        Save changes</button>
    </div>
  )
}
