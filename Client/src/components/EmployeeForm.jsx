...
const EmployeeForm = ({ initialData, onSuccess, onCancel }) => {
  ...
  return (
    <form action="" className="space-y-6 max-w-3xl animate-fade-in">
      ...
      <div className="card p-5 sm:p-6">
        <h3 className="text-base font-medium test-slate-900 mb-6 pb-4 border-b border-slate-100">
          Account Setup
        </h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700">
          <div className="sm:col-span-2">
...
<button className="btn-primary flex items-center justify-center" disabled={loading} type="submit">
{loading && <Loader2Icon className="w-4 h-4 me-2 animate-spin"/>}
{
