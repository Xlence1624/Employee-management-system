...
<div className="text-center border-b border-slate-200 pb-6 mb-8">
  ...
  <p>{format(new Date(paySlip.year, paySlip.month - 1), "MMMM yyyy")}</p>
</div>
...
<div className="">
  <p className='text-xs text-slate-400 uppercase tracking-wider mb-1'>Employee Position</p>
...
<button className='btn-primary print:hidden' onClick={() => window.print()}>Print Payslip
